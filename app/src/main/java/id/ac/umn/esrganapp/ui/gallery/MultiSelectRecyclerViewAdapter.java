...
public class MultiSelectRecyclerViewAdapter extends RecyclerView.Adapter<MultiSelectRecyclerViewAdapter.ViewHolder> {
    ...
    MultiSelectRecyclerViewAdapter(Context context, List<GalleryThumbnail> data) {
